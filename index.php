...
<body>
	...
	<div class="menu-principal">
		<div class="container-fluid">
			<div class="row-fluid">
				<header class="span2">
					<h1><a href="#" class="logo-ypf-comunidad"><span class="hide">YPF Comunidad</span></a></h1>
				</header>
	...
	<div id="container-principal" class="container-fluid">
		...
		<footer class="row-fluid">
			<div class="span5 nota">

				<p><span class="quote"></span><strong>La Fundación YPF tiene un nuevo rumbo estratégico:</strong></br>
				<strong>Educar para la energía.</strong> El cambio de paradigma energético en el país
				necesita de una nueva generación de profesionales.</p>
			</div>
			...
			<div class="span5 offset2 colRight">
				<ul class="social">
					...
					<li class="last"><a href="#" title="Contacto" class="contacto"><span class="hide">Contacto</span></a></li>
				</ul>

				<ul class="mainLinks">
					<li><a href="#">Mapa de sitio</a></li>
					<li><a href="#">Políticas de Privacidad</a></li>
					<li class="last"><a href="#">Copyright ©Fundación YPF 1996-2012</a></li>
				</ul>
			</div>
		</footer>
